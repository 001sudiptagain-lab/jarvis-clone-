...
def _load_system_prompt() -> str:
    try:
        ...
        return (
            "You are ZYROX, an advanced AI assistant. "
...
TOOL_DECLARATIONS = [
    ...
    },
    {
        ...
        "description": (
            ...
            "close the assistant, say goodbye, or stop ZYROX. "
...
class JarvisLive:
    def __init__(self, ui: JarvisUI):
        ...
        if get_push_to_talk_enabled():
            try:
                ...
                print(f"[ZYROX] ⚠ Push-to-talk unavailable: {e}")
        ...
        if q:
            ...
            while True:
                try:
                    ...
                    break
            if drained:
                print(f"[ZYROX] ✋ Interrupted — {drained} audio chunks discarded")
        self.set_speaking(False)
    ...
    def _build_config(self) -> types.LiveConnectConfig:
        ...
        try:
            ...
            self._asst_name = (_cfg.get("assistant_name") or "ZYROX").strip()
            _user_name = (_cfg.get("user_name") or "").strip()
        except Exception:
            self._asst_name = "ZYROX"
            _user_name = ""
    ...
    async def _execute_tool(self, fc) -> types.FunctionResponse:
        ...
        print(f"[ZYROX] 📤 {name} → {str(result)[:80]}")
    ...
    async def _listen_audio(self):
        ...
        try:
            ...
            if _mic_dev is not None:
                print(f"[ZYROX] 🎤 Input device: {_mic_name}")
            try:
                ...
                if _mic_dev is None:
                    raise
                print(f"[ZYROX] ⚠️  Mic '{_mic_name}' failed: {_e} — using default")
                self.ui.write_log(
                    ...
                    if _sru is not None:
                        if getattr(_sru, "resumable", False) and getattr(_sru, "new_handle", None):
                            if self._resume_handle is None:
                                print("[ZYROX] 🔗 Session resumption armed")
    ...
    async def _play_audio(self):
        ...
        try:
            ...
            if _spk_dev is None:
                raise
            print(f"[ZYROX] ⚠️  Output device '{_spk_name}' failed: {_e} — using default")
        ...
        try:
            ...
            print(f"[ZYROX] 🔊 Output latency {self._out_latency*1000:.0f} ms "
    ...
    async def _send_startup_briefing(self) -> None:
        ...
        print("[ZYROX] Briefing phase 1 (greeting) sent.")
        ...
        async def _deliver_news():
            try:
                ...
                print("[ZYROX] Briefing phase 2 (news) sent.")
            except Exception as e:
                print(f"[Briefing] Phase 2 error: {e}")
                print(f"[ZYROX] Briefing phase 2 failed: {e}")
                ...
                if not speaking and not recent_speech:
                    try:
                        ...
                        for alert in alerts:
                            ...
                            print("[ZYROX] Monitor alert sent.")
    ...
    async def _run_proactive_mode(self) -> None:
        ...
        while True:
            ...
            try:
                ...
                print("[ZYROX] Proactive check-in.")
            except Exception as e:
        ...
        while True:
            try:
                ...
                if _is_reconnect_signal(e):
                    print("[ZYROX] Voluntary reconnect requested.")
                ...
                if _resumed_with and (
                    ...
                    print("[ZYROX] 🔗 Resumption handle rejected — starting a fresh session")
                ...
                err_str = str(e)
                print(f"[ZYROX] Error ({type(e).__name__}): {e}")
                traceback.print_exc()
                ...
                if self._tuned_live and (
                    ...
                    print("[ZYROX] Live tuning rejected — reconnecting without it.")
                    continue
                ...
                if "API key not valid" in err_str or "1007" in err_str:
                    ...
                    print("[ZYROX] New API key saved — reconnecting...")
                    _conn_backoff = 3
                    continue
            ...
            print(f"[ZYROX] Reconnecting in {delay}s...")
